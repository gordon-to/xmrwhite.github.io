...
Creating the app itself is straightforward, and GitHub’s documentation walks through it well. This is the guide I followed and would recommend bookmarking:

https://docs.github.com/en/apps/creating-github-apps/creating-a-github-app

The only thing I’ll emphasize here — because it does matter later — is that:
